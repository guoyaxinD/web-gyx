!
  function(a, b) {
    ...
    function(a, b) {
      ...
      function g(a) {
        return a.postalCode = a.addressPostalCode,
      ...
      function i(a, b) {
        ...
        if (b) {
          ...
          -1 != e.indexOf("fail_") && (e = e.substring(5)),
            e = e.replace(/_/g, " "),
            e = e.toLowerCase(),
          ("access denied" == e || "no permission to execute" == e) && (e = "permission denied"),
      ...
      if (!a.jWeixin) {
        ...
        var G = !1,
          ...
          I = {
            config: function(a) {
              ...
              n(function() {
                if (b) c(p.config, {
                  ...
                  F.state = 1;
                  for (var a = E._completes,
                         d = 0,
                         e = a.length; e > d; ++d) a[d]();
                  E._completes = []
                }
              }),
              D.beta && o()
            ...
            addCard: function(a) {
              for (var b = a.cardList,
                     d = [], e = 0, f = b.length; f > e; ++e) {
                var g = b[e],
                  h = {
                    card_id: g.cardId,
                    card_ext: g.cardExt
